...
const ITEMS_MOVED_STOCK_MSG = langStringDefault("applyMarketChanges.8c31909e1a8a44865307fb46d04eae61");
...
CustomEvent.registerCef("market::applyChanges", async (player, changes: MarketItemChangesDto[]) => {
    ...
    player.notify(player.user.LangString("applyMarketChanges.24d092da41d279429fb41cee7f6cc905"), "success");
