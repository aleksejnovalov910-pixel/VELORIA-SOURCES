...
export class TradeTent {
    ...
    public constructor(
        ...
        this.interactColshape = colshapes.new(colshapePosition, player => player?.user?.LangString("TradeTent.b9c4d8f1c395c1166d2d016eb6bdab29") ?? langStringDefault("TradeTent.b9c4d8f1c395c1166d2d016eb6bdab29"), this.openMarket.bind(this), {
            type: 27,
            radius: 2
        });
    ...
    public destroy(returnCompensation: boolean = false) {
        if (returnCompensation) {
            ...
            this.owner.user.addMoney(compensation, false, this.owner.user.LangString("TradeTent.9655d4a950a12f239de974ec3bcccf0e"));
        }
    ...
    public addMoney(money: number, soldItem: ItemEntity, soldItemAmount: number, buyerName: string) {
        ...
        this.owner.user.addMoney(ownerMoney, true, this.owner.user.LangString("TradeTent.5f6b56cacc3aa34b74d5b46d9a4d8e43"));
