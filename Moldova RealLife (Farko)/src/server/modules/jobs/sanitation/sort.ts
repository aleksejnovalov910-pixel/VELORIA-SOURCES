...
class Sort {
    ...
    public joinHandler = (player: PlayerMp) => {
        ...
        if (player.user.sanitationSquad)
            return player.notify(player.user.LangString("sort.04fede3c58946a47e19f03b6ab804020"), "error");
    ...
    public completedGameHandler = (player: PlayerMp) => {
        ...
        player.user.addMoney(50, true, player.user.LangString("sort.35e4d5317977f61e065b325e7253feee"));
