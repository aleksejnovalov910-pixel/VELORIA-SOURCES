...
export class SnowWarrior {
    ...
    notifyWin(isGreen: boolean): void {
        this._player.notify(this._player.user.LangString("snowWarrior.c346d77e7e72729e8097bcf9161d5bf5", isGreen ? langStringDefault("snowWarrior.b4d97f9fac040d08b7422455a2427913") : langStringDefault("snowWarrior.8be07924c99f52fee3b0e806a3a0a5d8")));
    }
