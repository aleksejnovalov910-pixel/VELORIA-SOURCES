...
import { DailyRewardModelEntity } from "./dailyReward";

import type { InventoryEquipList } from "@/shared/inventory";
import type { UserAchievmentData } from "@/shared/achievements";
import type { IUserStats } from "@/shared/userStats";
...
export class UserEntity extends BaseEntity {
  ...
  /** Горячие клавиши */
  @Column({ type: "varchar", length: 512, default: "[0,0,0,0,0,0,0,0,0]" })
  hotkeys: string;
  ...
  @Column({ type: "boolean", default: false })
  isBlockedByCriminals: boolean;

  @Column({ type: "text", default: "" })
  signature: string;

  @OneToMany(() => DailyRewardModelEntity, (dailyReward) => dailyReward.user)
  dailyRewards: DailyRewardModelEntity[];
}
@Entity({ name: "user_dating_entity" })
