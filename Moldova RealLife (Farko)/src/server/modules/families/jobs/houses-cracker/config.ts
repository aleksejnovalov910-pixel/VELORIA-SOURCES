...
export const RobberyTexts: string[] = [
    langStringDefault("config.ad61d385a70ad8fa8d89f26b27f560a7"),
    langStringDefault("config.75ac9ae00463a5711b076d1ace047cc9"),
    langStringDefault("config.24d33c208413fbbcbfe5af3b65b62686"),
    langStringDefault("config.fe39c81ed55e91a2228e56e2677af427")
];
...
export const QuestNpcParameters : NpcParameters = {
    ...
    Heading: 249.0,
    Model: "csb_agent",
    Name: langStringDefault("config.0f93de486b7632a55c9e7716536475bc")
}
