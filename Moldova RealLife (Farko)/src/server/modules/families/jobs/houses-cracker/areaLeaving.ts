...
function endRobberyTask(player: PlayerMp, isSuccessfully: boolean = true) {
    ...
    if (isSuccessfully) {
        player.notify(player.user.LangString("areaLeaving.74707ea221d0bc5b126cd2cf6a728264"));
        ...
        player.notify(player.user.LangString("areaLeaving.0b2e14f33bfaa9fbea835161cf5cd2ac"), "warning");
    }
}