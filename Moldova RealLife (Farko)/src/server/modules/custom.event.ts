...
interface IPerfomanceResult {
    eventName: string
    count: number// Anzahl, wie oft dieses Ereignis protokolliert wurde
    averageExecutionTime: number
}

const PERFOMANCE_MIN_TIME = 20 // Anzahl der Millisekunden, ab der eine Warnung in die Konsole geschrieben wird
