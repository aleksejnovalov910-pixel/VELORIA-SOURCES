...
export default class ActivityBuilder {
    ...
    private static buildColShapes(activity: BaseActivity, spot: IActivitySpot): void {
        ...
        colshapes.new(system.getVector3Mp(spot.pedPos[0]).subtract(new mp.Vector3(0, 0, 1)),
            player => player?.user?.LangString("activityBuilder.33a7049b24143a64553084c981e8e5f7") ?? langStringDefault("activityBuilder.33a7049b24143a64553084c981e8e5f7"),
        ...
        colshapes.new(system.getVector3Mp(spot.storagePos),
            player => player?.user?.LangString("activityBuilder.40d7642b17657ebd40224d4df9750acf") ?? langStringDefault("activityBuilder.40d7642b17657ebd40224d4df9750acf"),
