...
interface PedMp extends EntityMp {
	...
	putIntoVehicle(
		...
		seat: number,
		timeout: number,
		speed: putIntoVehicleSpeed,
		flag: putIntoVehicleFlag,
	): void;
...
interface EventMpPool {
	...
	addSocket(
		name: string,
		handle: (player: PlayerMp, ...args: any[]) => void,
	): void;
	addRemoteCounted(
		arg0: string,
		arg1: (player: PlayerMp, ...args: any) => void,
	): any;
	__add__: {
		(eventName: string, callback: (...args: any[]) => void): void;
		(events: { [name: string]: (...args: any[]) => void }): void;
		(eventName: string, callback: (...args: any[]) => void): void;
		(events: { [name: string]: (...args: any[]) => void }): void;
	};
	add(
