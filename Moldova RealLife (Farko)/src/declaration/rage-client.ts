...
interface Polygons {
  add: (vertices: Vector3Mp[], height: number, options?: { visible?: boolean, lineColorRGBA?: number[], dimension?: number }) => any;
  remove: (polygon: any) => void;
  exists: (polygon: any) => boolean;
  isPositionWithinPolygon: (position: Vector3Mp, polygon: any, dimension?: number) => boolean;
}
...
interface GameUiMp {
  clearPedInPauseMenu(): unknown;
  replaceColourWithRgba(arg0: number, arg1: number, arg2: number, arg3: number, arg4: number): unknown;
  givePedToPauseMenu(PlayerPedPreview: any, arg1: number): unknown;
  pauseMenuSetBusySpinner(arg0: boolean, arg1: number, arg2: number): unknown;
