...
interface Event {
  initCustomEvent(eventName: string, arg1: boolean, arg2: boolean, arg3: {});
  /**
...
/** The OES_texture_half_float extension is part of the WebGL API and adds texture formats with 16- (aka half float) and 32-bit floating-point views. */
