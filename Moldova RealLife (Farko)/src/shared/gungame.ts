...
/** Название системы*/
export const DEATHMATH_NAME = langStringDefault("gungame.bb42bff57234eec35d853b5e1f50aac6");
export const DEATHMATH_MAPS:{
    ...
    spawnPoints: {
        ...
        {name: langStringDefault("gungame.ca4995f60e1f0b8c66c9cead46d7d820"), center: {x: -1120.00, y: 4922.87, z: 218.31, r:50}, spawnPoints: [
    ...
    {name: langStringDefault("gungame.ccc60a81f801d1638557fed609d108dc"), center: {x: 2393.20, y: 3092.34, z: 48.15, r:50}, spawnPoints: [
    ...
    {name: langStringDefault("gungame.4437e0f40cc5918171c8c0d2980cc66e"), center: {x: 76.57, y: 3691.32, z: 39.70, r:50}, spawnPoints: [
    ...
    {name: langStringDefault("gungame.5c1b99a27cc83ee335b3bdd29c8e7587"), center: {x: 288.34, y: -1601.21, z: 31.27, r:50}, spawnPoints: [
...
export const DEATHMATH_MODE_NAMES = [langStringDefault("gungame.f06207dc78727323ddb7fbbb3d5763f1"), "GunGame", langStringDefault("gungame.09f4603f0eb179f01b330b60bca4fe41"), "Team DM (Normal)"]
...
export const DEATHMATH_TEAM_1_NAME = langStringDefault("gungame.ca8672bf5a86a35f8dabe18efe63c35d");
...
export const DEATHMATH_TEAM_2_NAME = langStringDefault("gungame.0cc2daf6a44658579021afa57079df2f");
...
export const DEATHMATH_GUNGAME_WEAPONS:{
    ...
    kills: number,
}[] = [{weapon: "weapon_machinepistol", name: langStringDefault("gungame.6805f31308a55fb74760c92ff8b94b8f"), kills:2},
    {weapon: "weapon_combatpdw", name: langStringDefault("gungame.90d7a519125b5e22f623ff45efbcebdc"), kills:2},
    {weapon: "weapon_smg", name: langStringDefault("gungame.8423f3fafae804ba19374d1cf8a7cc73"), kills:3},
    {weapon: "weapon_musket", name: langStringDefault("gungame.92023d47c1ed5cc3d4d0eb3739559853"), kills:1},
    {weapon: "weapon_dbshotgun", name: langStringDefault("gungame.916f33d69fdcc8143d90852ac072d072"), kills:1},
    {weapon: "weapon_heavyshotgun", name: langStringDefault("gungame.c4631773de285f4cff67772a4833b75a"), kills:2},
    {weapon: "weapon_bullpuprifle_mk2", name: langStringDefault("gungame.facfa9372668015f4bee26ed2c8e3bbf"), kills:2},
    {weapon: "weapon_militaryrifle", name: langStringDefault("gungame.808ca4771fdd2f8ad90dc3eb1b201f60"), kills:2},
    {weapon: "weapon_carbinerifle", name: langStringDefault("gungame.edf8b2dad9d71f44abe22c5bd3d14685"), kills:3},
    {weapon: "weapon_assaultrifle_mk2", name: langStringDefault("gungame.6d7fdecf3ff897a628ac71d4d188b692"), kills:4},
    {weapon: "weapon_sniperrifle", name: langStringDefault("gungame.9022a8b886f184362934f78b4ae465d8"), kills:1},
    // {weapon: 'weapon_heavysniper_mk2', name: 'Heavy Sniper Mk II', kills:3},
    {weapon: "weapon_mg", name: langStringDefault("gungame.e8ea49d71d2eec0b97004ade919b39f8"), kills:3},
    {weapon: "weapon_combatmg_mk2", name: langStringDefault("gungame.abf3a04b538ae3261832d9add751d35b"), kills:4},
    {weapon: "weapon_pistol50", name: langStringDefault("gungame.fb0aa6266df82a44ac9b1cb5849f504b"), kills:1},
    // {weapon: 'weapon_vintagepistol', name: 'Vintage Pistol', kills:2},
    {weapon: "weapon_revolver_mk2", name: langStringDefault("gungame.ed01e4f15e10be132fef2cd2e2734842"), kills:3},
    {weapon: "weapon_switchblade", name: langStringDefault("gungame.2be0b9a4d5fd3937d8cf56b902f14646"), kills:1}
...
export const DEATHMATH_DM_WEAPONS:{
    ...
    {weapon: "weapon_machinepistol", name: langStringDefault("gungame.a2156e57d1f5be34783871d4350ab9fe")},
    {weapon: "weapon_combatpdw", name: langStringDefault("gungame.b4af9cc4700c34d587c19442a413d20e")},
    {weapon: "weapon_smg", name: langStringDefault("gungame.cdeae54f32fedef8e007727b639baf94")},
    {weapon: "weapon_musket", name: langStringDefault("gungame.1809849f84eb5b141187e5e3db5bcfc1")},
    {weapon: "weapon_dbshotgun", name: langStringDefault("gungame.de3c5c2d0451e8e415364facf6b0f7b6")},
    {weapon: "weapon_heavyshotgun", name: langStringDefault("gungame.5cf3bb1299da22107ab6279ec79032e1")},
    {weapon: "weapon_bullpuprifle_mk2", name: langStringDefault("gungame.ca14d2f800a6eb6f0517fab698c8c3bb")},
    {weapon: "weapon_militaryrifle", name: langStringDefault("gungame.cef71f42a02b8a8a6ad20f25d2777491")},
    {weapon: "weapon_carbinerifle", name: langStringDefault("gungame.a0cf688d4103c680ac9001ba945fb7df")},
    {weapon: "weapon_assaultrifle_mk2", name: langStringDefault("gungame.335c44ca984e2d9c7743ec2d96615a57")},
    {weapon: "weapon_sniperrifle", name: langStringDefault("gungame.cef952d745c1ec9b4c552a22d2417a30")},
    // {weapon: 'weapon_heavysniper_mk2', name: 'Heavy Sniper Mk II'},
    {weapon: "weapon_mg", name: langStringDefault("gungame.ad437d603f2042095feacf8d7b54fd83")},
    {weapon: "weapon_combatmg_mk2", name: langStringDefault("gungame.ab0daf998a051af78e320ac9d8a33cf0")},
    {weapon: "weapon_pistol50", name: langStringDefault("gungame.0309dd776e98f1da15e22473b8273752")},
    // {weapon: 'weapon_vintagepistol', name: 'Vintage Pistol'},
    {weapon: "weapon_revolver", name: langStringDefault("gungame.9828f08406e4702e3b2d32aff9a5aa82")},
].filter(q => weapon_hashes.find(z => z[0].toLowerCase() === q.weapon.toLowerCase()))