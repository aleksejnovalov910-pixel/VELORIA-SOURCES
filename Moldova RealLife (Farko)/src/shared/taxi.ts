...
export const TAXI_CONF = {
    ...
    npc: {
        ...
        name: "Mihai",
        /** Местоположение */
        pos: new mp.Vector3(908.49, -155.16, 74.15),
        /** Угол поворота NPC */
        heading: 150,
    },
    ...
    carRent: {
        ...
        /** Drehwinkel des Fahrzeugs beim Bremsen */
        h: 237,
        /** Liste der Fahrzeuge, die gemietet werden können */
        cars: <{
            /** Fahrzeugmodell */
            model: string,
            /** Pauschalzahlung bei der Anmietung eines Autos */
            cost: number
        }[]>[
            {model: "taxi", cost: 500}
        ],
