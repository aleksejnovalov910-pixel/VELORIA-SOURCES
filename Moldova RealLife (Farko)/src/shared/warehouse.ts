...
export const WAREHOUSE_KEY_COST = 250;
/** Стоимость смены замка от склада */
export const WAREHOUSE_LOCK_CHANGE = 250;
...
export const WAREHOUSE_SLOTS_VARIANTS: {model: string, weight: number, cost: number, name: string, z: number}[] = [
    { model: "ex_prop_crate_closed_sc", weight: 400, cost: 200000, name: "Container 1", z: 0},
    { model: "prop_box_wood03a", weight: 500, cost: 275000, name: "Container 2", z: -0.1},
    { model: "prop_box_wood07a", weight: 600, cost: 300000, name: "Container 3", z: 0},
    { model: "ex_prop_crate_closed_bc", weight: 700, cost: 350000, name: "Container 4", z: 0},
    { model: "ex_prop_crate_clothing_bc", weight: 750, cost: 400000, name: "Container 5", z: 0},
    { model: "prop_boxpile_04a", weight: 800, cost: 500000, name: "Container 6", z: 0.65},
]