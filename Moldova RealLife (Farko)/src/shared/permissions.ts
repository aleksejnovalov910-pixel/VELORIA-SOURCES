export const permissions: PermissionConfigPool = {
    ...
    "admin:chest:access": {admin_level: 5},
    ...
    // "admin:openBagsMenu": {admin_level: 7},
    ...
    "admin:useredit:jail": {admin_level: 2},
    // Выдать розыск
    ...
    // Senden игрока в редактор персонажа
    ...
    "admin:familyBank": { admin_level: 7 },
    ...
    // Начать бизвар
    "fraction:bizwar:start": { rankLast: 2 },
    ...
    "admin:language:change": { admin_level: 6 },
}
