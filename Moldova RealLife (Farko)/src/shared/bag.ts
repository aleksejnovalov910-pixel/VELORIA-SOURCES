...
export const BAG_ATTACH = {
    ...
    grab_money: <BagAttachData>{d: 45, t: 0, p: 0},
    /** Ограбление кассовых аппаратов */
    grab_money_shop: <BagAttachData>{d: 45, t: 0, p: 0},
    /** Ограбление порта, где дают предметы */
    grab_item: <BagAttachData>{d: 45, t: 0, p: 0},
    /** Инкассаторка */
    gr6Money: <BagAttachData>{d: 45, t: 0, p: 0},
    /** Игра по захвату сумки с доставкой */
    box_game_owner: <BagAttachData>{d: 45, t: 0, p: 0}
}