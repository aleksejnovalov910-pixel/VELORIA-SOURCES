...
export const SUPPLY_WAR_INTERACTION_MESSAGE: string = langStringDefault("supplyWar.config.99311a467248c9feac92a99ed26365a6");
...
export const SUPPLY_WAR_BLIP_NAME: string = langStringDefault("supplyWar.config.8cea0948337c4c871960deeaa5af4aaf");
