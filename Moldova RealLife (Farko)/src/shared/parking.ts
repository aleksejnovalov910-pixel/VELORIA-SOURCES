...
export const PARKING_CARS_PLAYER_MAX = 5;
...
export const PARKING_DAY_COST = 100;
/** Стоимость стартовой оплаты парковки */
export const PARKING_START_COST = 250;
export const PARKING_EXIT = new mp.Vector3(1252.56, 230.1, -48.84);
...
export const PARKING_CARS: { x: number; y: number; z: number; h: number }[] = [
	{ x: 1309.35, y: 258.4, z: -49.48, h: 90 },
	{ x: 1309.35, y: 249.8, z: -49.48, h: 90 },
	{ x: 1309.35, y: 241.3, z: -49.48, h: 90 },
	{ x: 1309.35, y: 231.8, z: -49.48, h: 90 },
	{ x: 1295.35, y: 231.8, z: -49.48, h: 90 },
	{ x: 1295.35, y: 241.3, z: -49.48, h: 90 },
	{ x: 1295.35, y: 249.8, z: -49.48, h: 90 },
	{ x: 1281.0, y: 258.4, z: -49.78, h: 270 },
	{ x: 1281.0, y: 249.8, z: -49.48, h: 270 },
	{ x: 1281.0, y: 241.3, z: -49.48, h: 270 },
	// { x: 0, y: 0, z: 0, h: 0 },
];
