...
export const VEHICLE_GRAB_COOLDOWN_MINUTES = 25;
...
"bs17", "diavel", "duker", "dv4r", "goldwing", "gsx1000", "indian19", "km1000rr", "ktm390", "puncher", "Yamr1crone", "yzfr6", "zx10r", "vortex", "wolfsbane", "zombiea", "zombieb", "manchez2", "policeb"]
...
export const maxAfkRentCarTime = 60
...
export const enum VEHICLE_FUEL_RATE {
    SPEED = 0.0025,      // mai încet decât 0.0037
    PASSENGERS = 0.0007, // puțin mai puțin per pasager
    AFK = 0.015,         // consum AFK mai mic
    INTERVAL = 2,        // rămâne la 2 secunde
}
...
export const npcGrabCarSetting = {
    ...
    // incorrectCarText: ["Das ist mir klar, aber ich brauche dieses Verkehrsmittel nicht.", "Nein, ich brauche es nicht.", "Ich habe dieses Modell eigentlich nicht gewollt.", "Bringen Sie mir nichts, nur das, was ich verlange", langStringDefault("vehicles.dccb67fe1c1a20ac8d120c0cd3fa2252")]
    incorrectCarText: ["Este clar pentru mine, dar nu am nevoie de acest mijloc de transport.", "Nu, nu am nevoie de el.", "De fapt, nu am vrut acest model.", "Nu-mi aduceti nimic, doar ceea ce cer.", langStringDefault("vehicles.dccb67fe1c1a20ac8d120c0cd3fa2252")]
