...
export const HousesTeleportsList:HousesTeleportsItem[] = [
    {name: langStringDefault("houses.b5740feb5902aeeb971bd3cfa6af1515"), pos: new mp.Vector3(-772.91, 312.45, 84.70), posH: 174, carExit: new mp.Vector3(-796.12, 320.12, 84.69), carH: 184, inside: new mp.Vector3(-793.91, 332.37, 45.56), insideH: 350, rooms: [[-792.27,339.63,45.56,90],[-795.48,339.52,45.56,265],[-792.47,347.13,45.56,84],[-795.66,347.00,45.56,271],[-800.60,350.70,45.56,280],[-799.09,351.87,45.56,180],[-794.16,352.16,45.56,179],[-789.26,352.21,45.56,175],[-787.46,351.12,45.56,84]]
    },
    {
        name: langStringDefault("houses.6e5d1d300573da9d054c600c3d99b50c"),
    ...
    {
        name: langStringDefault("houses.8d744caae9cfbca7b3096c6841e56234"),
