...
export const TASK_NAME = (type: MINIGAME_TYPE) => {
    if (type === MINIGAME_TYPE.JAILHAMMER) return langStringDefault("prison.tasks.config.bb8a9d5dcb3c018d6eac67984dd9e1e5");
    if (type === MINIGAME_TYPE.JAILSEWING) return langStringDefault("prison.tasks.config.de03f9e8119f12a0f1c28a33f03b2112");
    if (type === MINIGAME_TYPE.JAILWASHING) return langStringDefault("prison.tasks.config.60d86bc8ff7c6ec85db70252696859ae");
    if (type === MINIGAME_TYPE.JAILCOOKING) return langStringDefault("prison.tasks.config.c829e7be47edc66ac44a8a32562387bd");
    if (type === MINIGAME_TYPE.JAILTOILET) return langStringDefault("prison.tasks.config.7fd2e9b35222162a61084b0514ecf774");
    return "";
}
