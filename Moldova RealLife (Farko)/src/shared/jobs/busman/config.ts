...
export const HALT: Halt = {
    blipSprite: 1,
    blipColor: 73,
    blipName: langStringDefault("jobs.busman.config.c1878c4a3b43efc613dd3b0f9f343fba"),
    colshapeRange: 5,
    markerScale: 5,
...
export const EMPLOYER_NPC: EmployerNPC = {
    ...
    Name: langStringDefault("jobs.busman.config.232136f3c1f3a4b51f3d4ea593dd561a"),
    Range: 10,
    Dimension: 0
}
...
export const EMPLOYER_BLIP: EmployerBlip = {
    ...
    Name: langStringDefault("jobs.busman.config.636c1d8bbe4ac7d1d8ae69f82821224a")
}
...
export const BUS_LEVELS: JobLevel[] = [
    {
        index: 0,
        fromEXP: 0,
        description: langStringDefault("jobs.busman.config.f2fa3b3efb5c74767588d64bcc91913f"),
        salary: 0,
        vehicleModel: "bus",
        payment: 195
    },
    {
        index: 1,
        fromEXP: 1000,
        description: langStringDefault("jobs.busman.config.8bfac7f0d9fe99b5ece8b32192acdd0d"),
        salary: 1,
        vehicleModel: "bus",
        payment: 220
    },
    {
        index: 2,
        fromEXP: 2000,
        description: langStringDefault("jobs.busman.config.b29d9f164cd84816fcd7cac6bb63b947"),
        salary: 2,
        vehicleModel: "coach",
        payment: 270
    },
    {
        index: 3,
        fromEXP: 5000,
        description: langStringDefault("jobs.busman.config.2202cd15dfdfe29b3513dc49aa1177cb"),
        salary: 3,
        vehicleModel: "bus",
        payment: 350
    },
    {
        index: 4,
        fromEXP: 10000,
        description: langStringDefault("jobs.busman.config.b5d84dd486a2cec14ed6a88290662b01"),
        salary: 4,
        vehicleModel: "airbus",
        payment: 500
    }
