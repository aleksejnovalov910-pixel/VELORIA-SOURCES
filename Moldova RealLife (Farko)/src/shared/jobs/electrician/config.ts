...
export const ELECTRICIAN_LEVELS: JobLevel[] = [
    {
        index: 0,
        fromEXP: 0,
        description: langStringDefault("jobs.electrician.config.ad73a943d3c24b5d2f9382dda1037fc7"),
        salary: 0,
        payment: 50,
    },
    {
        index: 1,
        fromEXP: 4000,
        description: langStringDefault("jobs.electrician.config.f1c873895be5ab47650ac74ad2e00444"),
        salary: 1,
        payment: 1000,
    },
    {
        index: 2,
        fromEXP: 10000,
        description: langStringDefault("jobs.electrician.config.17aea4cf13e5c8c521eaeaf3eaf2d100"),
        salary: 2,
        payment: 2000,
    }
]
...
export const EMPLOYER_NPC: EmployerNPC = {
    ...
    Name: langStringDefault("jobs.electrician.config.692a53abe3f8e6f63c3a4e29c3a10197"),
    Range: 10,
    Dimension: 0
}
...
export const EMPLOYER_BLIP: EmployerBlip = {
    ...
    Name: langStringDefault("jobs.electrician.config.4826661b05bdf3775de0f69149b470e5")
}
...
export const VEHICLE_SPAWN_BLIP = {
    sprite: 756,
    color: 83,
    name: langStringDefault("jobs.electrician.config.cc6ee8e6dec150f145cfcd13d877f346")
}
