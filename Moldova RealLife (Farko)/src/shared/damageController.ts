...
export const DAMAGE_CONTROLLER_CONFIGS:{
    /** Besondere Waffen, falls erforderlich */
    weapon?:number,
    /** Direkt auf einen Kopfschuss prüfen */
    headShot?:boolean,
    /** Der Schaden wird nicht höher sein als der angegebene Schaden. Am besten ist es, wenn du ihn für eine bestimmte Waffe angibst. Wenn mehrere Gegenstände aus dieser Konfiguration mit dem Schaden übereinstimmen, wird der Gegenstand mit dem kleinsten Wert ausgewählt. */
    maxDamage?: number,
    /** Wie viel Schaden sollte multipliziert werden mit */
    ...
    /// vanator
    {weapon: mp.game.joaat("weapon_musket"), damageMultipler: 0.0, maxDamage: 0}, // musket
    //// vanator
    ...
    {weapon: mp.game.joaat("weapon_switchblade"), damageMultipler: 0.5, maxDamage: 35},
    {weapon: mp.game.joaat("weapon_snowball"), damageMultipler: 2, maxDamage: 1}, //Schneeball
    { weapon: mp.game.joaat('WEAPON_UNARMED'), damageMultipler: 0.8, maxDamage: 10 }, //UNARMED
]
