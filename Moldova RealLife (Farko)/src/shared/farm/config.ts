...
export const ACTIVITY_SETTINGS: Map<ActivityType, IActivitySettings> = new Map([
    [ActivityType.Field, { managerPedHash: 0x94562DD7, name: langStringDefault("farm.config.77f13d9f7002b643d34eb79116a3a182"), pointSize: 5, vehicleModel: "tractor2" }],
    [ActivityType.Animal, { managerPedHash: 0x94562DD7, name: langStringDefault("farm.config.e6bafb60caad99e284ff75a79816901a"), pointSize: 1 }],
    [ActivityType.Greenhouse, { managerPedHash: 0x94562DD7, name: langStringDefault("farm.config.5b16438cb9fae910a5d234d41b3e479c"), pointSize: 1 }],
])
