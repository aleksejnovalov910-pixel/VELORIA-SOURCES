...
export const ISLAND_BATTLE_FRACTIONS: IIslandBattleCommand[] = [
    {   id: 24,
        name: langStringDefault("islandBattle.index.4a461fa2970c888d6f02d29a39efd087"),
        fullName: langStringDefault("islandBattle.index.97c56ba2edabfe796789a7451a9b5e5b"),
        color: [255,255,255,255],
        preparePosition: new mp.Vector3(2744.07, 1346.50, 23.52)
    },
    {   id: 25,
        name: langStringDefault("islandBattle.index.d9686f6a72633779f23bc8acc3d60470"),
        fullName: langStringDefault("islandBattle.index.651ca6911da00d7981677b1f91cd66d6"),
        color: [255,255,255,255],
        preparePosition: new mp.Vector3(3831.34, 4463.74, 1.72)
    },
    {   id: 23,
        name: langStringDefault("islandBattle.index.4a6489fd102c565f31a9a366f42ca90e"),
        fullName: langStringDefault("islandBattle.index.c5d1c7e0707a4e07b073ca35896eff98"),
        color: [255,255,255,255],
