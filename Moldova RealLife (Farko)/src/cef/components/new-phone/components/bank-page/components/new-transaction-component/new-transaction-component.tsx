      ...
      <div className="np-new-transaction">
        ...
        >
          ...
          this.props.taxCategory !== undefined
            ? LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.51931e023d3a8592d14acd1b522c7bc8")
            : LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.2476538442215ef5cb49855a1750d165")}
        </button>
        <div className="np-new-transaction-title">
          {this.props.type === TransactionType.TRANSFER
            ? LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.64acfa27f0777e0f7568d9fccef56732")
        ...
        <div className="np-new-transaction-user-balance-wrap">
          {LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.3f5efb50ca9e2e5ff2e3890bd32d0b6b")}
        ...
        {this.props.type === TransactionType.TRANSFER ? (
          <div className="np-new-transaction-transfer">
            <label className="np-new-transaction-form-field">
              {LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.e7ce5a5982fefc03601e599946c210b0")}
              <input
                className="input"
            ...
            <label className="np-new-transaction-form-field">
              {LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.655f75325da332dc81968d23d94996b2")}
              <input
                className="input"
                type="number"
          ...
          <div className="np-new-transaction-tax">
            <div className="np-new-transaction-tax-info">
              {LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.4faab54a2a566ae836e5a309543a134b")}
        ...
        <button className="np-new-transaction-confirm" onClick={() => {
          if (this.props.type === TransactionType.TRANSFER) {
            if (!this.state.recipientCard) return CEF.alert.setAlert("error", LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.6857251875d3336e7b3d53e7177859f6"));
            if (this.state.transactionAmount < 100 || this.state.transactionAmount > 100000)
              return CEF.alert.setAlert("error", LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.22c7d198a924fa981fb2ba37a1b28f17"));
            if (CEF.user.bank < this.state.transactionAmount) 
              return CEF.alert.setAlert("error", LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.488c0b44619abd283093a66695ec0805"));
            ...
            if (!this.state.transactionAmount)
              return CEF.alert.setAlert("error", LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.7d54ab6d6d26a1fd7f74bfb41d804283"));
            if (this.state.transactionAmount > this.props.taxSum) {
              return CEF.alert.setAlert("error", LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.2dfed40ae33763edcfeb8ff726a523d8"));
            }
          ...
          {this.props.type === TransactionType.TRANSFER
            ? LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.5a79ff8e14daf6ce7ff9ee4ef589735f")
            : LangString("components.new-phone.components.bank-page.components.new-transaction-component.new-transaction-component.92669a46af40e3e5115ac14114e6b167")}
        </button>
      </div>
    );
  }
