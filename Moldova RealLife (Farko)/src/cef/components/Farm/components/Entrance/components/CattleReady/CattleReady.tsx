  ...
  startRent(): void {
    ...
    if (isNaN(value) || value <= 0 || value > 999999)
      return CEF.alert.setAlert(
        "error",
        LangString(
          "components.Farm.components.Entrance.components.CattleReady.CattleReady.3536bd4f3f48ad522ac67e3335b90f27"
        )
      );
...
// 			{LangString(
// 				"components.Farm.components.Entrance.components.CattleReady.CattleReady.084f74f4d6ca09a829ccd57c99d055ca"
// 			)}
// 		</div>
...
// 			<div>
// 				{LangString(
// 					"components.Farm.components.Entrance.components.CattleReady.CattleReady.193659be80d8828530957a72303b12d8"
// 				)}
// 			</div>
// 			<span>
// 				{" "}
// 				{LangString(
// 					"components.Farm.components.Entrance.components.CattleReady.CattleReady.eef807ceda7d80da079e93b716116870"
// 				)}
// 			</span>
// 		</div>
...
// 			{LangString(
// 				"components.Farm.components.Entrance.components.CattleReady.CattleReady.c26d3591a65e5c38c557ad8cea2c5873"
// 			)}{" "}
// 			<br />
// 			{LangString(
// 				"components.Farm.components.Entrance.components.CattleReady.CattleReady.35520760d62cc4ca23c7c23ebeee8deb"
// 			)}
// 		</div>
...
// 				type="number"
// 				placeholder={LangString(
// 					"components.Farm.components.Entrance.components.CattleReady.CattleReady.4a8b5db92d9ebd3f4eae16df6e0699f4"
// 				)}
// 			/>
// 		</div>
...
// 				{LangString(
// 					"components.Farm.components.Entrance.components.CattleReady.CattleReady.6beb560ba8687e1a98cdacf234c68471"
// 				)}
// 			</div>
// 		</div>
// 	</div>
