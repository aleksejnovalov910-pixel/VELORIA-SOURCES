...
class StartCutscene {
	...
	stop() {
		...
		CustomEvent.triggerServer("server:user:personage:doneCutscene");
	...
	private subscribeToEvents() {
		CustomEvent.registerServer("enableStartCutscene", () => {
			this.play(mp.players.local.isMale() ? 'male' : 'female');
		})
	}
}
