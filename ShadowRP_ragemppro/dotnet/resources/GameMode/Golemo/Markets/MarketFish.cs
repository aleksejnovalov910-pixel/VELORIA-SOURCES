...
namespace Golemo.Markets
{
    ...
    class MarketFish : Script
    {
        ...
        {
            new Product(5600, 209, "Корюшка", true, "Трофейный экземпляр, который мечтает получить каждый рыбак. Рыбка очень красивая и капризна"),
            new Product(4500, 210, "Кунджа", true, "Вид лучепёрых рыб, азиатский эндемик из рода гольцов семейства лососёвых. Кунджа крупная рыба "),
            new Product(4750, 211, "Лосось", true, "Семейство лучепёрых рыб из отряда лососеобразных. В составе семейства представлены как анадромные, так и пресноводные виды рыб."),                                                      
            new Product(3000, 212, "Окунь", true, "Вид лучепёрых рыб рода пресноводных окуней семейства окунёвых. Очень часто попадается рыбакам"),
            new Product(4200, 213, "Осётр", true, "Род пресноводных, полупроходных и проходных рыб из семейства осетровых."),
            new Product(8000, 214, "Скат", true, "Настоящее сокровище, очень редко попадается рыбакам"),
            new Product(3200, 215, "Тунец", true, "Морская хищная рыба"),
            new Product(5200, 216, "Угорь", true, "Очень длинная рыба, можно сказать самая некрасивая по виду, но поймать его это честь для рыбака"),
            new Product(6300, 217, "Чёрный амур", true, "Очень большая рыба и не найти ее рыбаку грех!"),
            new Product(5720, 218, "Щука", true, "Длинная речная рыба, попадается достотчно часто"),
        };
