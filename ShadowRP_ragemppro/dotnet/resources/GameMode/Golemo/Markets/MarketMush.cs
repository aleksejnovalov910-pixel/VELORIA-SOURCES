...
namespace Golemo.Markets
{
    ...
    class Market : Script
    {
        ...
        {
            new Product(5600, 1000, "Гриб", true, "Обычный гриб, очень часто попадается, есть можно"),
            new Product(7400, 1001, "Боровик", true, "Маленький, но съедобный. По виду толстенький"),
            new Product(4400, 1002, "Красный мухомор", true, "Ядовитый гриб, лучше не есть его, но можешь продать его мне"),                                                      
            new Product(5580, 1003, "Галерина окаймлённая", true, "Очень ядовитый гриб, лучше его не есть, а то и умереть можно, но его можно продать"),
            new Product(6400, 1004, "Белый гриб", true, "Самый безобидный гриб"),
            new Product(4400, 1005, "Поганка", true, "Ядовитый гриб и его куча в лесах, но можешь его продать"),
            new Product(690000, 1006, "Золотой гриб", true, "Самый дорогой гриб"),
        };
