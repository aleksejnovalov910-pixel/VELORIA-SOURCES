    ...
    class Commands : Script
    {
        ...
        public static void CMD_getInfoHelp(Player player, int personid)
        {
            try
            {
                ...
                {
                    player.SendChatMessage($"/createstock-Создать склад");
                    player.SendChatMessage($"/givemoney-Выдать деньги");
                    player.SendChatMessage($"/givereds-Выдать донатную валюту");
                    player.SendChatMessage($"/takeoffbiz-Забрать бизнес");
                    player.SendChatMessage($"/createsafe-Поставить сейф");
                    player.SendChatMessage($"/allspawncar-Заспавнить все фракционные машины");
                    player.SendChatMessage($"/save-Сохранить координаты");
                    player.SendChatMessage($"/setfracveh-Задать фракционый транспорт");
                    player.SendChatMessage($"/createbusiness-Создать бизнес");
                    player.SendChatMessage($"/newfracveh-Создать фракционый транспорт");
                    player.SendChatMessage($"/udemorgan-Выпустить из деморгана");
                    player.SendChatMessage($"/newrentveh-Создать машину для аренды");
                    player.SendChatMessage($"/newjobveh-Создать машину для работы");
                    player.SendChatMessage($"/ar-Выдать броню");
                    player.SendChatMessage($"/oguns-Выдать оружие");
                    player.SendChatMessage($"/giveclothes-Выдать одежду");
                    player.SendChatMessage($"/delhouseowner-Убрать владельца дома");
                    player.SendChatMessage($"/deletebusiness-Удалить бизнес");
                    player.SendChatMessage($"/stop-Остановка сервера");
                    player.SendChatMessage($"/createunloadpoint-Создать точку выгрузки дальнобоев");
                    player.SendChatMessage($"/pa-Запустить анимацию");
                    player.SendChatMessage($"/newsimcard-Выдать новую сикарту");
                    player.SendChatMessage($"/fixgovbizprices-Исправить гос цены");
                    player.SendChatMessage($"/housetypeprice-Применить цену для однотипных домов");
                    player.SendChatMessage($"/svm-Поставить тюнинг");
                    player.SendChatMessage($"/lsn-Отправить новость вне очереди");
                    player.SendChatMessage($"/mtp-Телепорт по маск ид");
                    player.SendChatMessage($"/removesafe-Убрать сейф");
                    player.SendChatMessage($"/paydaymultiplier-Множитель х2 денег к пейдею");
                    player.SendChatMessage($"/setproductbyindex-Назначить продукт по индексу (отладка)");
                    player.SendChatMessage($"/deleteproducts-Удалить продукты");
                    player.SendChatMessage($"/changebizprice-Поменять стоимость бизнеса");
                    player.SendChatMessage($"/guns-Выдать оружие");
                    player.SendChatMessage($"/stt-Тюнинг на скорость");
                    player.SendChatMessage($"/expmultiplier-Множитель х2 опыта к пейдею");
                    player.SendChatMessage($"/payday-Запустить пейдей");
                    player.SendChatMessage($"/givelic-Выдать лицензию");
                    player.SendChatMessage($"/vehhash-?");
                    player.SendChatMessage($"/setbizmafia-Назначить мафию для бинеса");
                    player.SendChatMessage($"/setcolour-Изменить цвет территории (капт)");
                    player.SendChatMessage($"/startmatwars-Начать войну за маты");
                    player.SendChatMessage($"/setadmin-Сделать игрока админом");
                    player.SendChatMessage($"/setadminrank-Установить ранг админу");
                    player.SendChatMessage($"/deladmin-Снять админа с должности");
                    player.SendChatMessage($"/delleader-Снять лидера с должности");
                    player.SendChatMessage($"/setviplvl-Установить уровень випки");
                    player.SendChatMessage($"/sw Установить-погоду");
                    player.SendChatMessage($"/deljob Удалить-работу");
                    player.SendChatMessage($"/giveexp Выдать-опыт");
                    player.SendChatMessage($"/changestock-Изменить состояние склада");
                    player.SendChatMessage($"/setleader-Назначить лидера");
                    player.SendChatMessage($"/giveammo-Выдать патроны");
                    player.SendChatMessage($"/createmp-Cоздать МП");
                    player.SendChatMessage($"/startmp-Начать МП");
                    player.SendChatMessage($"/stopmp-Остановить МП");
                    player.SendChatMessage($"/sendcreator-Отправить игрока в редактор персонажа");
                    player.SendChatMessage($"/changename-Сменить имя");
                    player.SendChatMessage($"/offdelfrac-Выгнать из фракции (офлайн)");
                    player.SendChatMessage($"/vehc-Заспаунить транспорт с настройкой цвета");
                    player.SendChatMessage($"/setdim-Переместиться в дименшн");
                    player.SendChatMessage($"/skick-Тихий кик");
                    player.SendChatMessage($"/global-Глобальный чат");
                    player.SendChatMessage($"/setskin-Выдать скин");
                    player.SendChatMessage($"/veh-Заспавнить транспорт");
                    player.SendChatMessage($"/fixcar-Починить транспорт");
                    player.SendChatMessage($"/ban-Забанить игрока");
                    player.SendChatMessage($"/delfrac-Выгнать из фракции");
                    player.SendChatMessage($"/warn-Выдать предупреждение");
                    player.SendChatMessage($"/unwarn-Снять предупреждение");
                    player.SendChatMessage($"/checkmoney-Посмотреть кол-во денег игрока");
                    player.SendChatMessage($"/fz-Заморозить игрока");
                    player.SendChatMessage($"/delacar-Удалить все заспавненные машины");
                    player.SendChatMessage($"/ufz-Разморозить игрока");
                    player.SendChatMessage($"/offban-Забанить игрока (офлайн)");
                    player.SendChatMessage($"/rescar-Респаун машины");
                    player.SendChatMessage($"/checkprop-Проверить игрока на имущество");
                    player.SendChatMessage($"/offjail-Выпустить из деморгана (офлайн)");
                    player.SendChatMessage($"/offwarn-Снять предупреждение (офлайн)");
                    player.SendChatMessage($"/kill-Убить игрока");
                    player.SendChatMessage($"/tpc-Телепорт по координатам");
                    player.SendChatMessage($"/hp-Выдать здоровье");
                    player.SendChatMessage($"/metp-Телепорт игрока к себе");
                    player.SendChatMessage($"/demorgan-Отравить игрока в деморган");
                    player.SendChatMessage($"/tp-Телепорт к игроку");
                    player.SendChatMessage($"/admins-Список админов онлайн");
                    player.SendChatMessage($"/gm-Проверка на ГМ (подброс вверх)");
                    player.SendChatMessage($"/sp-Следить за игроком");
                    player.SendChatMessage($"/mute-Выдать мут игроку");
                    player.SendChatMessage($"/agm-Включить ГМ");
                    player.SendChatMessage($"/unmute-Снять мут с игрока");
                    player.SendChatMessage($"/inv-Невидимость");
                    player.SendChatMessage($"/afuel-Заправить машину ");
                    player.SendChatMessage($"/stats-Статистика персонажа ");
                    player.SendChatMessage($"/delad-Удалить объявление ");
                    player.SendChatMessage($"/kick-Кикнуть игрока ");
                    player.SendChatMessage($"/tpcar-Телепортировать машину");
                    player.SendChatMessage($"/redname-Красный ник ");
                    player.SendChatMessage($"/a-Админский чат ");
                    player.SendChatMessage($"/id-Ид игрока ");
                    player.SendChatMessage($"/asms-Написать игроку ");
                    player.SendChatMessage($"/ans-Ответ на репорт");
                }
        ...
        public static void CMD_redname(Player player)
        {
            try
            {
                ...
                {
                    player.SendChatMessage("~r~Админский никнейм включен");
                    player.SetSharedData("REDNAME", true);
                }
                else
                {
                    player.SendChatMessage("~r~Админский никнейм выключен");
        ...
        public static void CMD_paytoplayer(Player player, int id, int count)
        {
            ...
            if (count > 500000)
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Нельзя переводить больше 500 000$", 3000);
                return;
            }
            Player target = Main.GetPlayerByID(id);
            if (player == target)
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Нельзя передать себе деньги", 3000);
                return;
            }
            ...
            Notify.Send(target, NotifyType.Info, NotifyPosition.BottomCenter, $"Игрок ({player.Value}) передал Вам {count}$", 3000);
            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Вы передали игроку ({target.Value}) {count}$", 3000);
            ...
            Commands.RPChat("me", player, $"передал(а) {count}$ " + "{name}", target);
        }
        ...
        public static void SetPromoCommand(Player player, string text)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Вы уже вводили промокод на аккаунте", 3000);
                return;
            }
            ...
            {
                Notify.Error(player, "У вас уже был 3 уровень персонажа, поэтому ввод промокода недоступен");
                return;
            }
            ...
            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Вы успешно ввели промокод {text}, награда будет выдана при достижении 3 уровня", 3000);
        }
