...
namespace Golemo.Core
{
    class Admin : Script
    {
        ...
        public static void releasePlayerFromDemorgan(Player admin, Player target)
        {
            ...
            Notify.Send(target, NotifyType.Info, NotifyPosition.BottomCenter, $"Вы вышли из тюрмы, больше не нарушайте!", 3000);
        ...
        public static void freePlayerDemorgan(Player player)
        {
            NAPI.Task.Run(() =>
            {
                try
                {
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"Вы вышли из тюрмы, больше не нарушайте!", 3000);
                }
                catch { }
            });
        }
