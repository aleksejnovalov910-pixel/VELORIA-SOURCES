        ...
        private static void GiveOutPrizeMysticItem(Player player)
        {
            ...
            switch (randomInt)
            {
                case 0:
                    ...
                    Core.Weapons.GiveWeapon(player, ItemType.Flashlight, "Freedommod");
                    break;
                case 1:
                    ...
                    Core.Weapons.GiveWeapon(player, ItemType.BattleAxe, "Freedommod");
                    break;
                case 2:
                    ...
                    Core.Weapons.GiveWeapon(player, ItemType.FlareGun, "Freedommod");
                    break;
                case 3:
                    ...
                    Core.Weapons.GiveWeapon(player, ItemType.StunGun, "Freedommod");
                    break;
                case 4:
                    ...
                    Core.Weapons.GiveWeapon(player, ItemType.RepairKit, "Freedommod");
                    break;
            }
        }
