export const VeloriaEvents = {
  ...
  InventoryToggle: 'veloria:inventory:toggle', InventoryOpen: 'veloria:inventory:open', InventorySync: 'veloria:inventory:sync', InventoryMove: 'veloria:inventory:move', InventoryUse: 'veloria:inventory:use', InventoryDrop: 'veloria:inventory:drop',
