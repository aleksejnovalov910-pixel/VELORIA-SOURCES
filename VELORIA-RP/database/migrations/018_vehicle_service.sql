...
ALTER TABLE character_vehicles ADD COLUMN IF NOT EXISTS oil_level DOUBLE NOT NULL DEFAULT 100;
ALTER TABLE character_vehicles ADD COLUMN IF NOT EXISTS battery_health DOUBLE NOT NULL DEFAULT 100;
